...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/livescoin-cli.cpp \
           src/livescoin-tx.cpp \
           src/livescoin.cpp \
           src/db.cpp \
           ...
           src/qt/livescoin.cpp \
           src/qt/livescoinstrings.cpp \
...
RESOURCES += src/qt/livescoin.qrc src/qt/livescoin_locale.qrc

TRANSLATIONS += src/qt/locale/livescoin_bg.ts \
                src/qt/locale/livescoin_de.ts \
                src/qt/locale/livescoin_en.ts \
                src/qt/locale/livescoin_es.ts \
                src/qt/locale/livescoin_fi.ts \
                src/qt/locale/livescoin_fr.ts \
                src/qt/locale/livescoin_it.ts \
                src/qt/locale/livescoin_ja.ts \
                src/qt/locale/livescoin_pl.ts \
                src/qt/locale/livescoin_pt.ts \
                src/qt/locale/livescoin_ru.ts \
                src/qt/locale/livescoin_sk.ts \
                src/qt/locale/livescoin_sv.ts \
                src/qt/locale/livescoin_vi.ts \
                src/qt/locale/livescoin_zh_CN.ts \
                src/qt/locale/livescoin_zh_TW.ts
