...
/** Utility functions used by the LIVEsCOIN Qt UI.
 */
namespace GUIUtil
{
...
// Render LIVEsCOIN addresses in monospace font
...
// Parse "livescoin:" URI into recipient object, return true on successful parsing
