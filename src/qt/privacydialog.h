...
public:
    ...
    void setZLIVEsCOINControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzLIVES_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzLIVES_clicked();
    void on_pushButtonZLIVEsCOINControl_clicked();
