                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("LIVEsCOIN Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a LIVEsCOIN address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and livescoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About LIVEsCOIN Core"), this);
    aboutAction->setStatusTip(tr("Show information about LIVEsCOIN Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for LIVEsCOIN"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your LIVEsCOIN addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified LIVEsCOIN addresses"));
    ...
    openAction->setStatusTip(tr("Open a LIVEsCOIN: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the LIVEsCOIN Core help message to get a list with possible LIVEsCOIN command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("LIVEsCOIN Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to LIVEsCOIN network", "", count));
}
...
{
    QString strTitle = tr("LIVEsCOIN Core"); // default title
