...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("LIVEsCOIN Core livescoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  livescoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded livescoin transaction") + "\n" +
                               "  livescoin-tx [options] -create [commands]   " + _("Create hex-encoded livescoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded livescoin transaction
