...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop LIVEsCOIN server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "LIVEsCOIN server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* LIVEsCOIN features */
        {"livescoin", "masternode", &masternode, true, true, false},
        {"livescoin", "listmasternodes", &listmasternodes, true, true, false},
        {"livescoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"livescoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"livescoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"livescoin", "masternodedebug", &masternodedebug, true, true, false},
        {"livescoin", "startmasternode", &startmasternode, true, true, false},
        {"livescoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"livescoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"livescoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"livescoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"livescoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"livescoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"livescoin", "mnbudget", &mnbudget, true, true, false},
        {"livescoin", "preparebudget", &preparebudget, true, true, false},
        {"livescoin", "submitbudget", &submitbudget, true, true, false},
        {"livescoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"livescoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"livescoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"livescoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"livescoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"livescoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"livescoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"livescoin", "checkbudgets", &checkbudgets, true, true, false},
        {"livescoin", "mnsync", &mnsync, true, true, false},
        {"livescoin", "spork", &spork, true, true, false},
        {"livescoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"livescoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use livescoind, or the -server option to livescoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> livescoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:17311/\n";
}
