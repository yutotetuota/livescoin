...
In order to support loading of multiple wallets in livescoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is livescoin.cpp.
...
Changes to livescoin.cpp
----------------------
livescoin.cpp is the entry point into livescoin-qt, and as such, will require some minor modifications to provide hooks for
