Contributing to LIVEsCOIN Core
============================

The LIVEsCOIN Core project operates an open contributor model where anyone is
...
The following applies to code changes to the LIVEsCOIN Core project, and is not to be
confused with overall LIVEsCOIN Network Protocol consensus changes.

Whether a pull request is merged into LIVEsCOIN Core rests with the project merge
...
Patches that change LIVEsCOIN consensus rules are considerably more involved than
...
Where a patch set proposes to change the LIVEsCOIN consensus, it must have been
...
The project leader is the release manager for each LIVEsCOIN Core release.
